CREATE TABLE IF NOT EXISTS `tbl_roles` (
  ...
  `HierarchyOrder` int NOT NULL DEFAULT '1',
  ...
  KEY `FK_tbl_roles_ParentRole` (`ParentRoleId`),
  KEY `FK_tbl_roles_tbl_users_CreatedBy` (`CreatedBy`),
  KEY `FK_tbl_roles_tbl_users_UpdatedBy` (`UpdatedBy`),
  CONSTRAINT `FK_tbl_roles_ParentRole` FOREIGN KEY (`ParentRoleId`) REFERENCES `tbl_roles` (`Id`) ON DELETE RESTRICT,
